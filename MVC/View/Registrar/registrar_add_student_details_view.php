...
<div class="dashboard-content">
    ...
    <div class="container">
        ...
        <?php endif; ?>
        <!-- Add Student Form -->
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?users_id=" . $_GET['users_id'] . "&user_id=" . $_GET['user_id'] . "&email=" . $_GET['email'] . "&phone=" . $_GET['phone']; ?>" onsubmit="return validateAddStudentForm();">
