    ...
    <div class="dashboard-content">
        ...
        <div class="container">
            ...
            <div class="search-box">
                <!-- Apply leave button -->
                <button class="apply-leave-btn" onclick="redirectToApplyLeave(<?php echo htmlentities($userId); ?>)">Apply Leave</button>
                <!-- Search form -->
                <form action="registrar_leave_status_controller.php" method="GET">
            ...
            <p id="noMatchMessage" style="display: <?php echo (mysqli_num_rows($leaveDetails) === 0) ? 'block' : 'none'; ?>">No matching records found.</p>
