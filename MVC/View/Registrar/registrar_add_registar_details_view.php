...
<head>
    ...
    <title>Add Registrar Details</title>
...
<div class="dashboard-content">
    ...
    <div class="container">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?users_id=" . $_GET['users_id'] . "&user_id=" . $_GET['user_id'] . "&email=" . $_GET['email'] . "&phone=" . $_GET['phone']; ?>" onsubmit="return validateAddRegistrarForm();">
            <label for="RegisterName">Register Name:</label>
            <input type="text" id="RegisterName" name="RegisterName"><br>
