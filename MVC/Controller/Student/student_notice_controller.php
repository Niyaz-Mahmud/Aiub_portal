...
include '../../Model/Student/student_notice_model.php';
...
$notices = fetchStudentResources($userId, $start_from, $results_per_page);

// Include the view file
include '../../View/Student/student_notice_view.php';
?>
