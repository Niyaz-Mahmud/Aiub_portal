...
include '../../Model/Registrar/registrar_leave_status_model.php';
...
if(isset($_GET['search'])) {
    ...
    $leaveDetails = searchLeaveDetails($userId, $searchTerm, $start_from, $results_per_page);
} else {
    $leaveDetails = fetchLeaveDetails($userId,$start_from, $results_per_page);
}

// Include view file
include '../../View/Registrar/registrar_leave_status_view.php';
